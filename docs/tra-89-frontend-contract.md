...
| Métricas scoped      | `PersonMetrics`                                    | `GET /personas/{id}/metricas`                            | `PersonaMetricas`                         | Conteos por rol en el subárbol; sólo persona o descendientes autorizados                         |
| Mapa scoped          | `ScopedMap`                                        | `GET /personas/{id}/mapa`                                | `PersonaMapaScoped`                       | Geocercas asignadas dentro del subárbol; sin coordenadas personales                              |
